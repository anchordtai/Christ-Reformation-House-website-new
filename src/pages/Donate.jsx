...
import { buildFlutterwaveCardPaymentMethod } from '../utils/flutterwaveCrypto'
...
const Donate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const paymentMethodPayload = await buildFlutterwaveCardPaymentMethod({
      ...
      // Do not treat a successful charge creation response as final payment success.
      // Flutterwave may require PIN/3DS/OTP/redirect authentication.
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="card">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6" autoComplete="off">
                    ...
                    {paymentMethod === 'card' && <div className="space-y-4 rounded-lg border border-gray-200 p-4 bg-gray-50">
                      ...
                      <p className="text-xs text-gray-600">Your card fields are encrypted in the browser before being sent to the payment API. They are not stored in the CRH database.</p>
                    </div>}

                    {paymentMethod === 'bank_transfer' && <div className="rounded-lg bg-blue-50 border border-blue-200 p-4 text-sm text-blue-800">Bank-transfer checkout will be enabled after we verify the first card V4 flow. This prevents us from introducing another payment branch before the core transaction and webhook flow is confirmed.</div>}

                    <div className="rounded-lg bg-green-50 border border-green-200 p-4 flex gap-3">
                      <ShieldCheck className="w-6 h-6 text-green-600 flex-shrink-0" />
                      <p className="text-sm text-green-800">Flutterwave V4 encryption is used before payment data leaves your browser. Your Flutterwave Client Secret, Supabase service-role key, and webhook secret never enter the frontend.</p>
                    </div>
              ...
              <div>
                <div className="card bg-blue-50 border-2 border-blue-200">
                  ...
                  <ul className="space-y-3 text-gray-700"><li>❤️ Support our mission to spread the Gospel</li><li>❤️ Help us serve our community</li><li>❤️ Enable our ministries to grow</li><li>❤️ Make a lasting impact</li></ul>
                </div>
